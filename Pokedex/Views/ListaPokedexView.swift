...
struct ListaPokedexView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            print("ListaPokedexView.onAppear - Iniciando carga inicial de Pokémon")
            loadInitialPokemon()
        }
    ...
    private func applyFiltersAndSort() {
       ...
       if filteredAndSortedPokemon.count < 10 && hasMorePokemon && !isLoading { // Mantén la lógica de carga si la lista es pequeña
            loadMorePokemon()
            applyFiltersAndSort()
        }
    }
